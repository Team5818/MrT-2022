...
public class ClimbConstants {
    ...
    public static final double MAX_CLIMB_VELOCITY = 4;
    public static final double MAX_CLIMB_ACCELERATION = 2;
    public static final int TIMEOUT_MS = 60;
    public static final double GEAR_RATIO = 800;
    public static final double CLIMB_ENCODER_TICKS = 4096;
