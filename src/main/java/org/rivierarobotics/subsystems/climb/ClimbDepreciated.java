...
public class ClimbDepreciated extends SubsystemBase {

    public static ClimbDepreciated getInstance() {
        if (climb == null) {
            climb = new ClimbDepreciated();
        }
        return climb;
    }

    private static ClimbDepreciated climb;
