...
public class MotorIDs {
    ...
    //climb ids
    public static final int SOLENOID_LOW_OPEN = 3;
    public static final int SOLENOID_LOW_CLOSED = 6;
    public static final int SOLENOID_MID_OPEN = 2;
    public static final int SOLENOID_MID_CLOSED = 5;
    public static final int SOLENOID_HIGH_OPEN = 4;
    public static final int SOLENOID_HIGH_CLOSED = 7;
